...
wage Phillips gave γ\_w = 1.59 \textgreater{} 1) or because they require
GMM on forward recursions (spreads, UIP). The audit confirms the
\textbf{flat AU Phillips} stylised fact: only the lag coefficient is
identified (λ\_π = 0.259, t = 2.76, R² = 0.063); output-gap, VA-price,
and import-price channels are all insignificant. Under the post-audit
calibration, the response to a 100 bp annualized cash-rate tightening
produces a real-GDP trough of −0.106\% at Q8, an output-gap trough of
−0.069\% at Q8, CPI inflation falling −0.020 pp year-on-year at Q16
(weaker and slower than pre-audit, reflecting the AU flat-Phillips
finding), the AUD appreciating 0.980\% at Q8 via a forward-looking UIP
NPV channel, and the 10-year yield rising 0.103 pp on impact. A
...
Wage Phillips λ\_w & 0.21 & −0.082 & −1.64 & 121 & 0.77 & reverted (BK
fail; γ\_w=1.59) & \\
Wage Phillips γ\_w & 0.46 & 1.594 & 15.27 & & & reverted & \\
Wage Phillips κ\_w & 0.054 & 0.371 & 3.18 & & & reverted & \\
...
structure) that were not touched by the audit. The CPI/wage IRF response
...
tightening) --- Phase L2 OLS audit
(2026-05-28)}\label{table-6.3-peak-irf-100bp-annualized-monetary-tightening-phase-l2-ols-audit-2026-05-28}
...
OLS for CPI Phillips, trade quantities, trade and other deflators (see
§6.6 Phase L2 OLS audit below).
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Real GDP (ln\_Q)} & \textbf{−0.106\%} & Q8 \\
Output gap (yhat\_au) & \textbf{−0.069\%} & Q8 \\
CPI inflation (pi\_au, y/y) & \textbf{−0.020 pp} & Q16 \\
VA price inflation (piQ, y/y) & +0.033 pp & Q1 \\
CPI deflator inflation (pi\_c, y/y) & +0.001 pp & Q11 \\
Consumption growth (Δlog) & \textbf{−0.020\%} & Q1 \\
...
Exchange rate (s\_gap, \%) & \textbf{−0.980\%} & Q8 \\
10Y yield (annualised) & \textbf{+0.103 pp} & Q1 \\
\end{longtable}
}
