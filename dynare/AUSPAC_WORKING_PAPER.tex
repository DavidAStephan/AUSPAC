...
0.078, t=2.98) --- SA re-estimate; was 0.266 pre-SA & \textbf{0.0519} &
{[}0.0215, 0.0805{]} \\
...
\item
  ...
  speed to French data. \emph{(The other entries in the table above are
  from the pre-SA estimation snapshot and the hybrid-MCMC posterior;
  only β₀ has been refreshed to the SA re-estimate --- a full
  re-tabulation of the consumption sub-coefficients on the SA layer is
  pending.)}
\item
