...
(2026-05-28). - The L2 OLS estimates of the PAC equation parameters
(b0\_c, b1\_c, b0\_pQ, etc.) were obtained using the OLD
\texttt{yhat\_au} as a regressor in the iterative-OLS procedure. They
are not formally re-optimal under the new structural definition. A
