...
= −0.10 corresponding to a positive structural Phillips slope. Under
equation-by-equation OLS calibration (wp1044 methodology), the response
to a 100 bp annualized cash-rate tightening produces a real GDP trough
of −0.107\% at Q8, an output-gap trough of −0.073\% at Q8, CPI inflation
falling −0.038 pp year-on-year at Q9, the AUD appreciating 0.979\% at Q8
via a forward-looking UIP NPV channel, and the 10-year yield rising
0.102 pp on impact. A cross-block finding emerges from the Phase L2
...
tightening) --- equation-by-equation OLS
calibration}\label{table-6.3-peak-irf-100bp-annualized-monetary-tightening-equation-by-equation-ols-calibration}
...
within the first 40 quarters. Calibration: equation-by-equation OLS
following wp1044 methodology.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Real GDP (ln\_Q)} & \textbf{−0.107\%} & Q8 \\
Output gap (yhat\_au) & \textbf{−0.073\%} & Q8 \\
CPI inflation (pi\_au, y/y) & \textbf{−0.038 pp} & Q9 \\
VA price inflation (piQ, y/y) & +0.034 pp & Q1 \\
CPI deflator inflation (pi\_c, y/y) & −0.043 pp & Q11 \\
Consumption growth (Δlog) & \textbf{−0.004\%} & Q7 \\
...
Exchange rate (s\_gap, \%) & \textbf{−0.979\%} & Q8 \\
10Y yield (annualised) & \textbf{+0.102 pp} & Q1 \\
\end{longtable}
}
