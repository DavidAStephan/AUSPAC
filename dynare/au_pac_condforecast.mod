...
// Conditional forecast paths (auto-generated)
conditional_forecast_paths;
var i_au;
periods 1:16;
values 0.0625, 0.1250, 0.1875, 0.2500, 0.2500, 0.2500, 0.2500, 0.2500, 0.2000, 0.1500, 0.1000, 0.0500, 0.0000, 0.0000, 0.0000, 0.0000;
end;

conditional_forecast(parameter_set = calibration, controlled_varexo = (eps_i), replic = 5000);

plot_conditional_forecast(periods = 16) yhat_au pi_au i_au dln_c dln_ib dln_ih dln_n i_10y;
