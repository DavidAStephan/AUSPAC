...
|-----------|-----------|-------------------|--------------------------|---------|
| β₀ (EC speed on `c* − c`) | **0.29** | **0.2307** (SE 0.078, t=2.98) — SA re-estimate; was 0.266 pre-SA | **0.0519** | [0.0215, 0.0805] |
