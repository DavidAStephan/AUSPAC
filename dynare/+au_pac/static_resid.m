...
residual = zeros(152, 1);
    ...
    residual(12) = (y(113)) - (x(34)+y(98)*params(19)-y(97)+params(20)*y(114));
    residual(13) = (y(98)) - (y(98)+x(35));
    residual(14) = (y(115)) - (x(36)+y(102)*params(45)-y(101)+params(46)*y(116));
    residual(15) = (y(102)) - (y(102)+x(37));
    residual(16) = (y(117)) - (x(38)+y(105)*params(54)-y(104)+params(55)*y(118));
    residual(17) = (y(105)) - (y(105)+x(39));
    residual(18) = (y(119)) - (x(40)+y(108)*params(63)-y(107)+params(64)*y(120));
    residual(19) = (y(108)) - (y(108)+x(41));
    residual(20) = (y(121)) - (x(42)+y(111)*params(37)-y(110)+params(38)*y(122));
    residual(21) = (y(111)) - (y(111)+x(43));
    residual(22) = (y(12)) - (params(16));
    residual(23) = (y(100)) - (y(100)+y(13)-params(16));
residual(24) = y(31);
residual(25) = y(36);
residual(26) = y(41);
residual(27) = y(24);
    ...
    residual(35) = (y(15)) - (y(100)-y(99));
    residual(36) = (y(123)) - (x(9)+y(1)*params(21)+params(19)*(y(98)-y(99))+params(20)*y(124)+y(142));
    ...
    residual(46) = (y(125)) - (x(11)+y(1)*params(43)+params(37)*(y(111)-y(112))+params(38)*y(126)+params(39)*y(127)+params(40)*y(128)+params(41)*y(129)+y(141));
...
residual(49) = y(33);
    ...
    residual(51) = (y(130)) - (x(12)+y(1)*params(49)+y(9)*params(48)+params(45)*(y(102)-y(103))+params(46)*y(131)+y(138));
...
residual(54) = y(47);
    ...
    residual(58) = (y(132)) - (x(13)+y(9)*params(59)+y(1)*params(58)+params(54)*(y(105)-y(106))+params(55)*y(133)+params(56)*y(134)+y(139));
    ...
    residual(63) = (y(135)) - (x(14)+y(9)*params(68)+y(1)*params(67)+params(63)*(y(108)-y(109))+params(64)*y(136)+params(65)*y(137)+y(140));
    residual(64) = (y(49)) - (y(49)*params(74)+params(73)*(1-params(74))+x(16));
    residual(65) = (y(50)) - (y(2)*(1-params(72))+y(50)*params(72));
    ...
    residual(93) = (y(92)) - (params(146)*(1-params(145))+y(48)*(1-params(145))+y(92)*params(145));
    residual(94) = (y(93)) - (y(48)*(1-params(145))+params(145)*y(93));
    residual(95) = (y(94)) - (y(48)*(1-params(145))+(1-params(145))*params(147)+params(145)*y(94));
    residual(96) = (y(95)) - (y(48)*(1-params(145))+(1-params(145))*params(148)+params(145)*y(95));
    residual(97) = (y(81)) - (y(92)*params(137)-y(89));
    residual(98) = (y(82)) - (y(93)*params(138));
    residual(99) = (y(83)) - (y(89)+y(94)*(-(params(137)+params(138)+params(139)))+y(91));
    residual(100) = (y(84)) - (y(95)*params(139)-y(91));
    residual(101) = (y(89)) - (y(89)*(1-params(143))+params(143)*params(140));
    residual(102) = (y(91)) - (y(91)*(1-params(143))+params(143)*params(142));
    residual(103) = (y(90)) - ((1-params(143))*y(90)+params(143)*params(141)+y(1)*0.05);
    residual(104) = (y(85)) - (y(36)*(-params(113))-(y(89)-params(140))+params(137)*(y(92)-(params(15)+params(73)+params(146))));
    residual(105) = (y(86)) - (y(69)*(-params(115))+y(1)*0.30-(y(90)-params(141))+params(138)*(y(93)-(params(15)+params(73))));
    residual(106) = (y(87)) - (params(112)*(y(1)-y(31))-y(41)*params(114)+(-(params(137)+params(138)+params(139)))*(y(94)-(params(15)+params(73)+params(147))));
    residual(107) = (y(88)) - (params(139)*(y(95)-(params(15)+params(73)+params(148))));
    residual(108) = (y(77)) - (y(85)+0.98*y(77)+params(137)*0.02);
    residual(109) = (y(78)) - (y(86)+0.98*y(78)+params(138)*0.02);
    residual(110) = (y(79)) - (y(87)+0.98*y(79)+(-(params(137)+params(138)+params(139)))*0.02);
    residual(111) = (y(80)) - (y(88)+0.98*y(80)+params(139)*0.02);
    residual(112) = (y(96)) - ((-(y(88)+y(87)+y(85)+y(86))));
residual(113) = y(113);
...
residual(132) = y(132);
    residual(133) = (y(133)) - (y(132));
    residual(134) = (y(134)) - (y(133));
residual(135) = y(135);
    residual(136) = (y(136)) - (y(135));
    residual(137) = (y(137)) - (y(136));
    residual(138) = (y(138)) - (y(102)*params(152)+y(101)*params(153)+y(102)*params(154)+params(155)*y(143)+params(156)*y(144));
    residual(139) = (y(139)) - (y(105)*params(157)+y(104)*params(158)+y(105)*params(159)+params(160)*y(145)+params(161)*y(146));
    residual(140) = (y(140)) - (y(108)*params(162)+y(107)*params(163)+y(108)*params(164)+params(165)*y(147)+params(166)*y(148));
    residual(141) = (y(141)) - (y(111)*params(167)+y(110)*params(168)+y(111)*params(169)+params(170)*y(149)+params(171)*y(150));
    residual(142) = (y(142)) - (y(98)*params(172)+y(97)*params(173)+y(98)*params(174)+params(175)*y(151)+params(176)*y(152));
    residual(143) = (y(143)) - (y(101));
    residual(144) = (y(144)) - (y(102));
    residual(145) = (y(145)) - (y(104));
    residual(146) = (y(146)) - (y(105));
    residual(147) = (y(147)) - (y(107));
    residual(148) = (y(148)) - (y(108));
    residual(149) = (y(149)) - (y(110));
    residual(150) = (y(150)) - (y(111));
    residual(151) = (y(151)) - (y(97));
    residual(152) = (y(152)) - (y(98));
