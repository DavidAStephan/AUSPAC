...
stoch_simul(order=1, irf=200, nograph, noprint) yhat_au pi_au pi_au_gap piQ pQ_level piQ_hat pi_c pi_m i_au i_gap u_gap pv_u_gap pv_i_uip pv_r_lh_gap dln_pcom s_gap i_10y ln_Q dln_c dln_ib dln_ih dln_n pi_w;
