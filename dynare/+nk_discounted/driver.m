...
M_.param_names(1) = {'sigma_nk'};
M_.param_names_tex(1) = {'sigma\_nk'};
M_.param_names_long(1) = {'sigma_nk'};
M_.param_names(2) = {'kappa_nk'};
M_.param_names_tex(2) = {'kappa\_nk'};
M_.param_names_long(2) = {'kappa_nk'};
M_.param_names(3) = {'beta_nk'};
M_.param_names_tex(3) = {'beta\_nk'};
M_.param_names_long(3) = {'beta_nk'};
M_.param_names(4) = {'rho_i_nk'};
M_.param_names_tex(4) = {'rho\_i\_nk'};
M_.param_names_long(4) = {'rho_i_nk'};
...
M_.param_names(7) = {'nu_disc'};
M_.param_names_tex(7) = {'nu\_disc'};
M_.param_names_long(7) = {'nu_disc'};
...
M_.dynamic_g1_sparse_rowval = int32([3 1 2 3 2 3 1 3 1 1 2 3 ]);
...
M_.block_structure_stat.block(1).variable = [ 3 1 2];
...
M_.block_structure_stat.block(1).g1_sparse_rowval = int32([1 3 1 2 3 1 2 3 ]);
M_.block_structure_stat.block(1).g1_sparse_colval = int32([1 1 2 2 2 3 3 3 ]);
M_.block_structure_stat.block(1).g1_sparse_colptr = int32([1 3 6 9 ]);
M_.static_g1_sparse_rowval = int32([1 2 3 1 2 3 1 3 ]);
M_.static_g1_sparse_colval = int32([1 1 1 2 2 2 3 3 ]);
M_.static_g1_sparse_colptr = int32([1 4 7 9 ]);
M_.params(1) = 1.0;
sigma_nk = M_.params(1);
M_.params(2) = 0.3;
kappa_nk = M_.params(2);
M_.params(3) = 0.99;
beta_nk = M_.params(3);
M_.params(4) = 0.80;
rho_i_nk = M_.params(4);
M_.params(5) = 1.5;
phi_pi = M_.params(5);
M_.params(6) = 0.5;
phi_x = M_.params(6);
...
save([M_.dname filesep 'Output' filesep 'nk_discounted_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'nk_discounted_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'nk_discounted_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'nk_discounted_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'nk_discounted_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'nk_discounted_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'nk_discounted_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'nk_discounted_results.mat'], 'options_mom_', '-append');
end
if ~isempty(lastwarn)
