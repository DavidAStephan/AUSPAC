...
try
    ...
    eqs = { ...
        'eq_piQ_pac', struct('b0_pQ',0.06,'b1_pQ',0.50,'b2_pQ',0.09), 'pac_pQ', 'VA Price'; ...
        'eq_dln_c_pac', struct('b0_c',0.06,'b1_c',0.149,'b2_c',-0.02,'b3_c',0.139), 'pac_c', 'Consumption'; ...
        'eq_dln_ib_pac', struct('b0_ib',0.030,'b1_ib',0.181,'b2_ib',0.10,'b3_ib',0.191), 'pac_ib', 'Business Inv'; ...
        'eq_dln_ih_pac', struct('b0_ih',0.049,'b1_ih',0.210,'b2_ih',0.08,'b3_ih',0.12,'b4_ih',-0.05), 'pac_ih', 'Household Inv'; ...
        'eq_dln_n_pac', struct('b0_n',0.040,'b1_n',0.30,'b2_n',0.10,'b3_n',0.05,'b4_n',0.02,'b5_n',0.12), 'pac_n', 'Employment'};
