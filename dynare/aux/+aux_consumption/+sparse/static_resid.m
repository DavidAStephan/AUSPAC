...
[T_order, T] = aux_consumption.sparse.static_resid_tt(y, x, params, T_order, T);
residual = NaN(20, 1);
    ...
    residual(14) = (y(14)) - (y(14)*params(28)+y(1)*params(29)+y(4)*params(30)+y(13)*params(31)+x(14));
    residual(15) = (y(15)) - (y(15)*params(33)+y(1)*params(34)+y(4)*params(35)+x(15));
    residual(16) = (y(16)) - (y(16)*params(36)+y(1)*params(37)+y(3)*params(38)+y(2)*params(39)+y(4)*params(40)+y(15)*params(41)+y(13)*params(27)+x(16));
    residual(17) = (y(18)) - (x(17)+y(1)*params(45)+y(3)*params(44)+params(42)*(y(16)-y(17))+params(43)*y(19)+y(20));
residual(18) = y(18);
    residual(19) = (y(19)) - (y(18));
    residual(20) = (y(20)) - (params(47)+y(1)*params(48)+y(3)*params(49)+y(2)*params(50)+y(4)*params(51)+y(5)*params(52)+y(6)*params(53)+y(7)*params(54)+y(8)*params(55)+y(9)*params(56)+y(10)*params(57)+y(11)*params(58)+y(12)*params(59)+y(13)*params(60)+y(14)*params(61)+y(15)*params(62)+y(16)*params(63));
end
