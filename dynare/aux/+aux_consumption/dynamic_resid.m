...
residual = zeros(18, 1);
    ...
    residual(13) = (y(29)) - (params(26)*y(13)+y(1)*params(27)+y(4)*params(28)+x(it_, 13));
    residual(14) = (y(30)) - (params(29)*y(14)+y(1)*params(30)+y(3)*params(31)+y(2)*params(32)+y(4)*params(33)+y(13)*params(34)+x(it_, 14));
    residual(15) = (y(32)) - (x(it_, 15)+y(17)*params(38)+y(3)*params(37)+params(35)*(y(14)-y(15))+params(36)*y(33)+y(34));
    residual(16) = (y(32)) - (y(31)-y(15));
    residual(17) = (y(33)) - (y(16));
    residual(18) = (y(34)) - (params(40)+y(1)*params(41)+y(3)*params(42)+y(2)*params(43)+y(4)*params(44)+y(5)*params(45)+y(6)*params(46)+y(7)*params(47)+y(8)*params(48)+y(9)*params(49)+y(10)*params(50)+y(11)*params(51)+y(12)*params(52)+y(13)*params(53)+y(14)*params(54));
