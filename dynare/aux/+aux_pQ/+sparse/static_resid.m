...
residual = NaN(19, 1);
    ...
    residual(14) = (y(14)) - (y(14)*params(35)+x(14));
    residual(15) = (y(15)) - (y(15)*params(23)+y(1)*params(24)+y(3)*params(25)+y(2)*params(26)+y(4)*params(27)+y(13)*params(28)+y(14)*params(36)+x(15));
    residual(16) = (y(17)) - (x(16)+y(1)*params(39)+params(37)*(y(15)-y(16))+params(38)*y(18)+y(19));
residual(17) = y(17);
    residual(18) = (y(18)) - (y(17));
    residual(19) = (y(19)) - (params(41)+y(1)*params(42)+y(3)*params(43)+y(2)*params(44)+y(4)*params(45)+y(5)*params(46)+y(6)*params(47)+y(7)*params(48)+y(8)*params(49)+y(9)*params(50)+y(10)*params(51)+y(11)*params(52)+y(12)*params(53)+y(13)*params(54)+y(14)*params(55)+y(15)*params(56));
end
