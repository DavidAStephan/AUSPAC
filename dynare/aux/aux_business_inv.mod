...
// =========================================================================
// aux_business_inv.mod — Phase L2.A regeneration aux file for business-inv PAC
...
// Aux regression coefficients (Phase W posteriors)
...
// Business-inv PAC short-run — au_pac.mod final overrides at lines 2085-2088 (wp1044 import)
b0_ib           = 0.096;        // wp1044 Table 3.5.13 override
b1_ib           = 0.33;         // wp1044 Table 3.5.13 override
b2_ib           = 0.11;         // wp1044 Table 3.5.13 override (depth-2 PAC)
b3_ib           = 0.69;         // wp1044 Table 3.5.13 override
