...
residual = zeros(20, 1);
    ...
    residual(13) = (y(31)) - (params(26)*y(13)+y(1)*params(27)+y(3)*params(28)+y(2)*params(29)+y(4)*params(30)+x(it_, 13));
    residual(14) = (y(33)) - (x(it_, 14)+y(19)*params(36)+params(31)*(y(13)-y(14))+params(32)*y(34)+params(33)*y(35)+params(34)*y(36)+params(35)*y(37)+y(38));
    residual(15) = (y(33)) - (y(32)-y(14));
    residual(16) = (y(34)) - (y(15));
    residual(17) = (y(35)) - (y(16));
    residual(18) = (y(36)) - (y(17));
    residual(19) = (y(37)) - (y(18));
    residual(20) = (y(38)) - (params(38)+y(1)*params(39)+y(3)*params(40)+y(2)*params(41)+y(4)*params(42)+y(5)*params(43)+y(6)*params(44)+y(7)*params(45)+y(8)*params(46)+y(9)*params(47)+y(10)*params(48)+y(11)*params(49)+y(12)*params(50)+y(13)*params(51));
