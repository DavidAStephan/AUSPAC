...
[T_order, T] = aux_employment.sparse.static_resid_tt(y, x, params, T_order, T);
residual = NaN(21, 1);
    ...
    residual(14) = (y(14)) - (y(14)*params(28)+y(1)*params(29)+y(3)*params(30)+y(2)*params(31)+y(4)*params(32)+y(13)*params(27)+x(14));
    residual(15) = (y(16)) - (x(15)+y(1)*params(38)+params(33)*(y(14)-y(15))+params(34)*y(17)+params(35)*y(18)+params(36)*y(19)+params(37)*y(20)+y(21));
residual(16) = y(16);
    residual(17) = (y(17)) - (y(16));
    residual(18) = (y(18)) - (y(17));
    residual(19) = (y(19)) - (y(18));
    residual(20) = (y(20)) - (y(19));
    residual(21) = (y(21)) - (params(40)+y(1)*params(41)+y(3)*params(42)+y(2)*params(43)+y(4)*params(44)+y(5)*params(45)+y(6)*params(46)+y(7)*params(47)+y(8)*params(48)+y(9)*params(49)+y(10)*params(50)+y(11)*params(51)+y(12)*params(52)+y(13)*params(53)+y(14)*params(54));
end
