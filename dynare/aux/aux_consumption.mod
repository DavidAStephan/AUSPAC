...
// =========================================================================
// aux_consumption.mod — Phase L2.A regeneration aux file for consumption PAC
// Reconstructed 2026-05-28 from commit 7995ce7^; parameter values resynced
// to post-L2-OLS / Phase L2.A production calibration in au_pac.mod.
// =========================================================================
...
// L2 OLS production values (au_pac.mod lines 723-724, 1922-1929)
lambda_pi       =  0.2588;
kappa_pi        = -0.0336;
alpha_pc        =  0.0006;
beta_pc_m       = -0.0042;
...
// Aux regression coefficients (L2 / Phase B posterior — already in production)
rho_yh_aux      =  0.93;        a_yh_y          = 0.12;         a_yh_u          = -0.07;
rho_c_aux       =  0.581;       a_c_y           = 0.058;        a_c_i           = -0.043;
a_c_pi          =  0.010;       a_c_u           = -0.036;       a_c_yh          =  0.10;

// AR(1) reduced forms for VAR (agents' beliefs)
rho_piQ         = 0.85;         rho_pm          = 0.2230;       rho_pcom        = 0.42;

// Rounds 4-8: PAYG tax + hand-to-mouth income channels
rho_tau_PAYG    = 0.92;         a_c_PAYG        = -0.10;
rho_wtH         = 0.50;         alpha_wtH_y     = 0.50;
alpha_wtH_u     = 0.30;         alpha_wtH_tau   = -0.40;        b_HtM           = 0.32;

// Consumption PAC short-run (L2 OLS — au_pac.mod lines 1890-1893)
b0_c            =  0.2661;      // was 0.0736
b1_c            =  0.0100;      // was 0.0375
b2_c            = -0.0137;      // was -0.333
b3_c            = -0.0005;      // was 0.022
