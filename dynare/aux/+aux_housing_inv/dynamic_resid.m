...
if T_flag
    T = aux_housing_inv.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(18, 1);
    ...
    residual(13) = (y(29)) - (params(26)*y(13)+y(1)*params(27)+y(3)*params(28)+y(2)*params(29)+y(4)*params(30)+x(it_, 13));
    residual(14) = (y(31)) - (x(it_, 14)+y(17)*params(34)+params(31)*(y(13)-y(14))+params(32)*y(32)+params(33)*y(33)+y(34));
    residual(15) = (y(31)) - (y(30)-y(14));
    residual(16) = (y(32)) - (y(15));
    residual(17) = (y(33)) - (y(16));
    residual(18) = (y(34)) - (params(36)+y(1)*params(37)+y(3)*params(38)+y(2)*params(39)+y(4)*params(40)+y(5)*params(41)+y(6)*params(42)+y(7)*params(43)+y(8)*params(44)+y(9)*params(45)+y(10)*params(46)+y(11)*params(47)+y(12)*params(48)+y(13)*params(49));
