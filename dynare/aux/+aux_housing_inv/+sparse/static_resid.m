...
[T_order, T] = aux_housing_inv.sparse.static_resid_tt(y, x, params, T_order, T);
residual = NaN(18, 1);
    ...
    residual(14) = (y(15)) - (x(14)+y(1)*params(34)+params(31)*(y(13)-y(14))+params(32)*y(16)+params(33)*y(17)+y(18));
residual(15) = y(15);
    residual(16) = (y(16)) - (y(15));
    residual(17) = (y(17)) - (y(16));
    residual(18) = (y(18)) - (params(36)+y(1)*params(37)+y(3)*params(38)+y(2)*params(39)+y(4)*params(40)+y(5)*params(41)+y(6)*params(42)+y(7)*params(43)+y(8)*params(44)+y(9)*params(45)+y(10)*params(46)+y(11)*params(47)+y(12)*params(48)+y(13)*params(49));
end
