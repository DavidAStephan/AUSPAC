# NEXT PROJECT — Industry Split: Mining (Supply-Driven) vs Non-Mining (Demand-Determined)
...
|---|---|---|
| Mining | `w_qn_m ≈ 0.117` | NEW thin supply block (§2.1) |
| Non-mining **market** | `w_qn_nm ≈ 0.60` | CES + FOC + PAC clone (§2.2) |
| Non-market (incl. dwellings) | `w_qn_nmk ≈ 0.28` | EXISTING `yhat_nonmarket` (`:1667-1671`), retained |
