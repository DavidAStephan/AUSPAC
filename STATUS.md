...
**Version**: v3.1.3 (Round 1.2 HtM income channel merged 2026-05-22, PR #8 — negative empirical result; structural plumbing kept for re-estimation follow-up)
**Architecture**: Phase T policy-function PAC expectations (FR-BDF wp1044 §2.2 / Adjemian-Brayton-Zimic), with Phases W/X/Y architectural cleanup completed, plus Round 1.1 HICP-style reporting block, 2026-05-21 Rounds 4-8 consolidation, and 2026-05-22 Round 1.2 hand-to-mouth wage+transfer income channel.
**Headline metric (current cache)**: Laplace LMD = **−784.47**, MHM LMD = **−785.80** — fresh 20k×2-chain MCMC under Round 1.2 completed 2026-05-22. **Round 1.2 worsens fit by 5.7 nats** vs the pre-Round-1.2 baseline (Laplace −779.29 / MHM −780.10). The calibrated `b_HtM = 0.32` (FR-BDF wp1044 posterior) is not supported on AU data; promoting to `estimated_params` is the recommended follow-up. Chains and mode file cached in `dynare/au_pac_bayesian/`; pre-Round-1.2 chains backed up at `dynare/au_pac_bayesian.cached_pre_round12_2026-05-22/`. Cumulative Phase Q → Rounds 4-8 consolidation MHM improvement: **+22.17 nats** (peak; Round 1.2 takes us back to ~+16.5 nats at the current calibration).
