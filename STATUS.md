...
**Headline metric (current cache)**: Laplace LMD = **−784.47**, MHM LMD = **−785.80** — fresh 20k×2-chain MCMC under Round 1.2 completed 2026-05-22. Round 1.2 worsened fit by 5.7 nats vs the pre-Round-1.2 baseline (Laplace −779.29 / MHM −780.10). The Phase L2 hybrid BI calibration locked 2026-05-26 has not yet been MCMC'd — pending. Cumulative Phase Q → current MHM improvement: **+16.5 nats**.
